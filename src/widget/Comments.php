...
namespace alpiiscky\comments\widget;
...
use alpiiscky\comments\assets\CommentsAsset;
use alpiiscky\comments\helpers\CommentsHelper;
use alpiiscky\comments\Module as CommentsModule;

/**
 * Class Comments
 * @package alpiiscky\comments\widget
 */
class Comments extends \yii\base\Widget
{
     ...
     * @var string
     */
    public $commentsView = '@vendor/alpiiscky/yii2-comments/src/widget/views/comments';

    /**
     * @var string
     */
    public $commentView = '@vendor/alpiiscky/yii2-comments/src/widget/views/_comment';

    /**
     * @var string
     */
    public $formView = '@vendor/alpiiscky/yii2-comments/src/widget/views/_form';
