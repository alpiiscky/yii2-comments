...
namespace alpiiscky\comments\models;
 ...
 * @property $status
 *
 * @package alpiiscky\comments\models
 */
class CommentsRating extends \yii\db\ActiveRecord
{
     ...
     * @var string
     */
    public static $commentRatingQueryModelClass = 'alpiiscky\comments\models\CommentsRatingQuery';
